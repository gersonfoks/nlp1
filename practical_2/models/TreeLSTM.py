...
from practical_2.models.LSTM import InputHiddenLayer
from practical_2.utils import get_pretrained_weights, t2i
...
def create_tree_lstm():
    ref = "embeddings/googlenews.word2vec.300d.txt"
    v, vectors = get_pretrained_weights(ref, zero_init_function)
    tree_lstm = TreeLSTMClassifier(len(v.w2i), 300, 150, len(t2i), v)
    tree_lstm.load_pretrained_weights(vectors)
    return tree_lstm
